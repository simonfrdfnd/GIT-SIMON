...
namespace NexioMax.ViewModels
{
  public partial class IoViewModel : ObservableObject, INavigationAware
  {
    ...
    [ObservableProperty]
    private ObservableCollection<string> _addresses = new ObservableCollection<string> { DefaultAddress };
    ...
    [ObservableProperty]
    private int selectedTimeout = 3000;

    [ObservableProperty]
    private ObservableCollection<string> _eosChars = new ObservableCollection<string> { "\\n", "\\r", "\\r\\n" };
      ...
      Application.Current.Dispatcher.BeginInvoke(new Action(() =>
      {
        try
        {
          ...
          if (!this.Addresses.Contains(this.SelectedAddress))
          {
            ...
            Settings.Default.Addresses.Insert(0, this.SelectedAddress);
            Settings.Default.Save();
          }
